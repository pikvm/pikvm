...
5. ??? note "If your kit includes the OLED display and/or the fan, you'll need to turn them on (Click to expand)"
...
8. ??? note "Check the HDMI backpowering problem (Click to expand)"
...
??? note "See the diagram (Click to expand)"
