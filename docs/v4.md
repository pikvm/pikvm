...
![PiKVM V4 Mini & Plus](overview.jpg "PiKVM V4 Mini (left) & Plus (right)")
...
=== "Front view"
    ...
    ![MISSING FRONT VIEW IMAGE](v4-front-view-numbered.svg){ height="250" }
...
=== "Rear view"
    ...
    ![MISSING REAR VIEW IMAGE](v4-rear-view-numbered.svg){ height="250" }
...
=== "Right view"
    ...
    ![MISSING SIDE VIEW IMAGE](v4-right-view-numbered.svg){ height="250" }
...
=== "Top view"
    ...
    ![MISSING TOP VIEW IMAGE](v4-top-view-numbered.svg){ height="250" }
