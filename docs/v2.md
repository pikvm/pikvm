...
4. **Board-specific: Power supply, USB connectivity, etc.**
    ...
    ??? success "✮ ✮ ✮ Raspberry Pi 4"
        ...
        ??? success "✮ ✮ ✮ Variant #1: Power supply + ready-made Y-splitter module"
            ...
            * *x1 USB-C/Power splitter Module
                * [An official from PiKVM team.](https://pikvm.org/buy/#pikvm-usb-power-data-splitter)
                * Third-party: [US](https://www.pishop.us/product/usb-c-pwr-splitter/)/[UK](https://www.tindie.com/products/8086net/usb-cpwr-splitter)/[CA](https://www.buyapi.ca/product/usb-c-pwr-splitter/).
