...
| [ezcoo EZ-SW41H21-KVMU3P 8K 4x1 switch](https://www.easycoolav.com/products/8k-hdmi-kvm-switch-4x1-with-usb30-kvm-4k120hz-hotkey-switch) | ☹ | Does NOT have a control port. Can be managed through key combo (ctrl+ctrl+#). Absolute mouse and MSD broken depending on the firmware version/model revision. See [#1463](https://github.com/pikvm/pikvm/issues/1463#issuecomment-4275771178) for more information.
